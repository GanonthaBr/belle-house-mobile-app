...
class WelcomeScreenImmobilier extends StatelessWidget {
  const WelcomeScreenImmobilier({super.key});
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: WelcomeScreenDescriptionText(
                          text:
                              "Retrouvez facilement des maisons  en location et en vente directement à partir de notre Application!",
                        ),
                      ),
                    ),
                    //dot indicator
